  ...
  return (
    <>
      <Head>
        ...
        <meta
          name="description"
          content="Bike service booking online - Your one-stop solution for effortless online bike repair bookings. Just a few clicks away from a seamless ride."
        />
      </Head>
      <ConfigureCodeBanner
      ...
      <HomeLayout>
        <Box position="relative" display="flex" flex={{ lg: '0 0 485px' }} height={{ base: '180px', lg: 'auto' }}>
          <Image
            flex="1"
            src={
              'https://images.unsplash.com/photo-1607109181641-74f8e7f4eb11?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w0NjA3NjB8MHwxfHNlYXJjaHwxfHxiaWtlJTIwcmVwYWlyfGVufDB8fHx8MTY5ODA2OTAzNHww&ixlib=rb-4.0.3&q=80&w=1080'
            }
            alt="Dinner"
            objectFit="cover"
          ...
          <Box position="absolute" top="0" backgroundColor="rgba(0,0,0,0.6)" width="100%" py="2">
            <Text align="center" fontSize="sm" color="white">
              Photo by{' '}
              <Link
                href="https://unsplash.com/@whoistaylorsmith?utm_source=roq-generator&utm_medium=referral"
                isExternal
                color="teal.200"
              >{`Taylor Smith`}</Link>{' '}
              on{' '}
        ...
        >
          <Box>
            ...
            <Text size="2xl" mb={{ base: '32px', lg: '48px' }} color="base.content" opacity="0.6">
              {`Bike service booking online - Your one-stop solution for effortless online bike repair bookings. Just a few clicks away from a seamless ride.`}
            </Text>
            <Box
